...
from src.rl.vlm_utils import annotate_batch
...
def main():
    ...
    parser.add_argument("--vlm-warmup-cap", type=float, default=0.5, help="Cap value for physical warmup frames")
    parser.add_argument("--vlm-tv-threshold", type=float, default=1.5, help="Total variation threshold for episode rejection")
            ...
            if len(unannotated_episodes) >= args.vlm_batch_size:
                if args.use_env_rewards:
                    ...
                    annotated_transitions = annotate_batch(
                        ...
                        warmup_cap=args.vlm_warmup_cap,
                        tv_threshold=args.vlm_tv_threshold
                    )
